...
CUSTOMS_HEADER_ALIASES: dict[str, list[str]] = {
    ...
    "country_code": [JP["partner_country_code"], JP["country_code"], "country", "partner code", "country code", "countrycode"],
    "country_name": [JP["partner_country_name"], JP["country_name"], "partner name", "country name", "country"],
    "import_value": [JP["amount"], "value", "value-year", "import value", JP["amount_thousand_yen"], "value(1,000yen)"],
    "quantity_2": [JP["quantity2"], JP["quantity2_alt"], "2nd quantity", "quantity2", "quantity2-year"],
